    ...
    def exec(soos_context):
        ...
        for i in range(SOOSSupportManifestAPI.API_RETRY_COUNT):
            try:
                ...
                print("SOOS: Currently Supported Manifest Types/Formats: ",supported_manifests) #need this???
                break
        ...
        api_response = json.loads(api_reponse) #turn json into python dict 
    ...
    def exec(soos_context):
        ...
        for i in range(0, SOOSStructureAPI.API_RETRY_COUNT):
            try:
                ...
                print("your status code", api_response.status_code)
                break
...
class SOOSAnalysisScript:
    ...
    def register_arguments():
        ...
        parser.add_argument("-buri", dest="base_uri",
                            help="API URI Path. Default Value: https://dev-api.soos.io/api/",
                            type=str,
                            # default="https://dev-api.soos.io/api/",
                            required=False
                            )
